    ...
    <aside
      className={cn(
        ...
        isSheet
          ...
          : "left-0 top-0 z-20 flex min-h-screen w-[300px] flex-col gap-3.5 overflow-y-hidden border-r bg-neutral-100/70 pb-3 pt-3 text-sm transition-transform duration-75 max-lg:fixed max-lg:-translate-x-full lg:sticky lg:min-w-[260px] lg:pt-2"
      )}
    >
